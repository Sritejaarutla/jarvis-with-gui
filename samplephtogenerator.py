...
while True:
    ...
    k = cv2.waitKey(1) & 0xff  # Waits for 1 millisecond until we press a key that condition we have to write using if


    if k == 27:  # Press 'ESC' to stop
        break
    elif count >=200:#e 300 or above sample photos for more accuracy(More sample --> More accuracy)
        break
